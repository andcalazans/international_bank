...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { document_number: @bank.document_number, document_type: @bank.document_type } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { document_number: @bank.document_number, document_type: @bank.document_type } }
